...
import com.technifysoft.comicbookapp.adapter.Adapter_Pdf_Admin;
        ...
        ref.orderByChild("category")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Pdf_List_User.this);
                        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
//                        khởi tạo và đổ vào adapter
                        Adapter_Pdf_Admin adapter_pdf_admin = new Adapter_Pdf_Admin(Pdf_List_User.this,pdfArrayList);
